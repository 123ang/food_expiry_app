...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'settings.themeNaturalGreen': 'Natural Green',
    'settings.themeNaturalGreenDesc': 'Fresh and natural green tones',
  ...
  zh: {
    ...
    'settings.themeNaturalGreen': '自然绿',
    'settings.themeNaturalGreenDesc': '清新自然的绿色调',
  ...
  ja: {
    ...
    'settings.themeNaturalGreen': 'ナチュラルグリーン',
    'settings.themeNaturalGreenDesc': '新鮮で自然な緑色調',
