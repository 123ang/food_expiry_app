export default {
  ...
  'list.tapAddToAddItem': '+ をタップしてアイテムを追加します。',
  'shoppingList.noItems': '買い物アイテムはまだありません',
  'wishList.noItems': 'ウィッシュリストのアイテムはまだありません',
  ...
  'settings.privateLocalMode': 'プライベートローカルモード',
  'settings.privateLocalModeDescription': '食品データはこの端末に保存され、クラウドには同期されません。',
  'settings.cloudModeDescription': 'このアカウントではクラウド同期が有効です。',
  'settings.cloudSync': 'クラウド同期',
  'settings.localModeInfoTitle': 'プライベートローカルモード',
  'settings.localModeInfoMessage': '食品データはこの端末にローカル保存されます。クラウドバックアップ、同期、家族共有が必要なときだけサインインしてください。',
  'settings.cloudOnlyFeatureTitle': 'クラウド機能',
  'settings.cloudOnlyFeatureMessage': 'クラウド同期、バックアップ、世帯共有にはクラウドアカウントが必要です。移行を選ぶまでローカルデータは非公開のままです。',
  'settings.upgradeToCloud': 'クラウドにアップグレード',
  'settings.sectionAccountGroups': 'アカウントとグループ',
  'settings.sectionPreferences': '環境設定',
  'settings.sectionManagement': '管理',
  'settings.sectionData': 'データと在庫',
  'settings.theme': 'テーマ',
  ...
  'settings.groupsDescription': '個人および家族グループを管理',
  'settings.yourGroups': 'あなたのグループ',
  'settings.createNewGroup': '新しいグループを作成',
  'groups.manageGroups': 'グループを管理',
  'settings.signOut': 'サインアウト',
  'settings.signOutDescription': 'アカウントからサインアウトして別のアカウントに切り替える',
  'settings.signOutConfirm': 'サインアウトしてもよろしいですか？データにアクセスするには再度サインインする必要があります。',
  'settings.signOutError': 'サインアウトに失敗しました。もう一度お試しください。',
  'settings.about': 'について',
  ...
  'settings.exportLocalData': 'ローカルデータを書き出す',
  'settings.exportLocalDataDescription': '食品、リスト、カテゴリ、場所のローカルJSONバックアップを保存',
  'settings.importLocalData': 'ローカルデータを読み込む',
  'settings.importLocalDataDescription': 'ローカルJSONバックアップを貼り付けてこの端末に統合',
  'settings.exportLocalSuccessTitle': 'ローカル書き出し完了',
  'settings.exportLocalSuccessMessage': '保存先:\n{path}\n\n書き出した食品アイテム: {items}',
  'settings.importLocalTitle': 'ローカルデータを読み込む',
  'settings.importLocalInstructions': 'Expiry Alertのローカル書き出しJSONを貼り付けてください。読み込みは記録を統合し、クラウドにはアップロードしません。',
  'settings.importLocalPlaceholder': '書き出しJSONをここに貼り付け',
  'settings.importLocalConfirmTitle': 'ローカルデータを読み込みますか？',
  'settings.importLocalConfirmMessage': '貼り付けたバックアップをこの端末のローカル保存データに統合します。一致する既存レコードは置き換えられる場合があります。',
  'settings.importLocalSuccessTitle': '読み込み完了',
  'settings.importLocalSuccessMessage': '{items}個の食品アイテム、{shopping}個の買い物アイテム、{wishlist}個のほしい物アイテムを読み込みました。',
  'settings.importLocalError': 'このバックアップを読み込めませんでした。JSONを確認してもう一度お試しください。',
  'settings.importLocalButton': '読み込む',
  ...
  'language.malay': 'マレー語',
  'language.close': '閉じる',
  'login.continueLocal': 'ローカルモードで続行',
  'login.localModeNote': '無料ローカルモードでは食品データをこの端末に保存します。クラウド同期はサインイン後にのみ開始されます。',
