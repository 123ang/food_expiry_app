export default {
  ...
  'home.noGroups': 'No groups found. Please create a group.',
  ...
  'list.tapAddToAddItem': 'Tap + to add an item.',
  'shoppingList.noItems': 'No shopping items yet',
  'wishList.noItems': 'No wish list items yet',
  ...
  'settings.privateLocalMode': 'Private Local Mode',
  'settings.privateLocalModeDescription': 'Food data stays on this device and is not synced to cloud.',
  'settings.cloudModeDescription': 'Cloud sync is active for this account.',
  'settings.cloudSync': 'Cloud Sync',
  'settings.localModeInfoTitle': 'Private Local Mode',
  'settings.localModeInfoMessage': 'Your food data is stored locally on this device. Sign in only when you want cloud backup, sync, or family sharing.',
  'settings.cloudOnlyFeatureTitle': 'Cloud Feature',
  'settings.cloudOnlyFeatureMessage': 'Cloud sync, backup, and household sharing need a cloud account. Your local data will stay private until you choose to move it.',
  'settings.upgradeToCloud': 'Upgrade to Cloud',
  ...
  'settings.signOutConfirm': 'Are you sure you want to sign out? You will need to sign in again to access your data.',
  ...
  'settings.exportLocalDataDescription': 'Save a local JSON backup of your food, lists, categories, and locations',
  'settings.importLocalData': 'Import Local Data',
  'settings.importLocalDataDescription': 'Paste a local JSON backup to merge it into this device',
  'settings.exportLocalSuccessTitle': 'Local Export Ready',
  'settings.exportLocalSuccessMessage': 'Saved to:\n{path}\n\nFood items exported: {items}',
  'settings.importLocalTitle': 'Import Local Data',
  'settings.importLocalInstructions': 'Paste an Expiry Alert local export JSON. Import merges records and does not upload data to cloud.',
  'settings.importLocalPlaceholder': 'Paste export JSON here',
  'settings.importLocalConfirmTitle': 'Import Local Data?',
  'settings.importLocalConfirmMessage': 'This will merge the pasted backup into local storage on this device. Existing matching records may be replaced.',
  'settings.importLocalSuccessTitle': 'Import Complete',
  'settings.importLocalSuccessMessage': 'Imported {items} food items, {shopping} shopping items, and {wishlist} wish items.',
  'settings.importLocalError': 'Could not import this backup. Check the JSON and try again.',
  ...
  'login.continueLocal': 'Continue in Local Mode',
  'login.localModeNote': 'Free Local Mode keeps your food data on this device. Cloud sync starts only after you sign in.',
